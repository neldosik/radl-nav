...
export const dict = {
  de: {
    ...
    shareRoute: 'Strecke teilen',
    shareCopied: 'Link kopiert',
    shareFailed: 'Link ließ sich nicht kopieren',
    routeBtn: 'Route',
    change: 'Ändern',
    ...
    stoerungTitel: 'Störungen auf der Strecke',
    stoerungTag: (n: number) => (n === 1 ? '1 Störung' : `${n} Störungen`),
    stoerungPlan: 'Fahrplanänderung',
    stoerungMehr: 'Mehr dazu',
    stoerungQuelle: 'Meldungen: MVG',
    ...
    histExport: 'Sichern',
    histImport: 'Einlesen',
    histExported: 'Fahrten als Datei gesichert',
    histImported: (n: number) =>
      n === 0 ? 'Nichts Neues — alle Fahrten waren schon da' : `${n} Fahrten übernommen`,
    histImportBroken: 'Datei nicht lesbar — erwartet wird eine Sicherung dieser App',
    histImportEmpty: 'Keine Fahrten in der Datei',
    histGpx: 'Weg als GPX',
  ...
  en: {
    ...
    cardDelay: (min: number) => `${min > 0 ? '+' : ''}${min} min`,
    stoerungTitel: 'Disruptions on this route',
    stoerungTag: (n: number) => (n === 1 ? '1 disruption' : `${n} disruptions`),
    stoerungPlan: 'Timetable change',
    stoerungMehr: 'More about this',
    stoerungQuelle: 'Alerts: MVG',
    ...
    histExport: 'Back up',
    histImport: 'Restore',
    histExported: 'Trips saved to a file',
    histImported: (n: number) =>
      n === 0 ? 'Nothing new — all trips were already here' : `${n} trips added`,
    histImportBroken: 'Cannot read the file — a backup from this app is expected',
    histImportEmpty: 'No trips in the file',
    histGpx: 'Track as GPX',
